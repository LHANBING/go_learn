...
// RedisStore 实现 verifycode store_interface
type RedisStore struct {
	RedisClient *redis.RedisClient
	KeyPrefix   string
}

// Set 实现 verifycode store_interface 的 Set 方法
...
// Get 实现 verifycode store_interface 的 Get 方法
...
// Verify 实现 verifycode store_interface 的 Verify 方法
